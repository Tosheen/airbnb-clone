...
const steps = ["location", "date", "info"] as const;
...
export const SearchModal = () => {
  ...
  const onNext = () => {
    setStep((prev) => (prev <= steps.length - 1 ? prev + 1 : steps.length - 1));
  };
  ...
  let bodyContent = (
    <div className="flex flex-col gap-8">
      ...
      />
      <CountrySelect
        value={location != null ? location : undefined}
  ...
  return (
    <Modal
      ...
      secondaryAction={stepName === "location" ? undefined : onBack}
      body={bodyContent}
    />
  );
};
